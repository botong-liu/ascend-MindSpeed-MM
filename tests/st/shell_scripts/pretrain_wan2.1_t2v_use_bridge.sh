...
MM_DATA="$BASEPATH/tests/st/run_configs/pretrain_wan2.1_t2v_use_bridge/data.json"
MM_MODEL="$BASEPATH/tests/st/run_configs/pretrain_wan2.1_t2v_use_bridge/model.json"
